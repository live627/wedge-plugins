...
function template_edit_post_field()
{
	...
	echo '
						...
						<dt>
							<strong>', $txt['pages_groups'], ':</strong>
						</dt>
						<dd>
							<div class="information">';
	...
	echo '
				...
				<fieldset>
					<legend>', $txt['pages_input'], '</legend>
					<dl class="settings">
						<dt>
							<strong>', $txt['pages_picktype'], ':</strong>
						</dt>
						<dd>
						...
						<dt id="max_length_dt">
							<strong>', $txt['pages_max_length'], ':</strong>
							<dfn>', $txt['pages_max_length_desc'], '</dfn>
						</dt>
						<dd id="max_length_dd">
							<input type="text" name="length" value="', $context['field']['length'], '" size="7" maxlength="6">
						</dd>
						<dt id="dimension_dt">
							<strong>', $txt['pages_dimension'], ':</strong>
						</dt>
						<dd id="dimension_dd">
							<strong>', $txt['pages_dimension_row'], ':</strong> <input type="text" name="rows" value="', $context['field']['rows'], '" size="5" maxlength="3">
							<strong>', $txt['pages_dimension_col'], ':</strong> <input type="text" name="cols" value="', $context['field']['cols'], '" size="5" maxlength="3">
						</dd>
						<dt id="bbc_dt">
							<strong>', $txt['pages_bbc'], '</strong>
						</dt>
						<dd id="bbc_dd">
						...
						<dt id="options_dt">
							...
							<strong>', $txt['pages_options'], ':</strong>
							<dfn>', $txt['pages_options_desc'], '</dfn>
						</dt>
						<dd id="options_dd">
							<div>';
	...
	echo '
								<span id="addopt"></span>
								[<a href="" onclick="addOption(); return false;">', $txt['pages_options_more'], '</a>]
							</div>
						</dd>
						<dt id="default_dt">
							<strong>', $txt['pages_default'], ':</strong>
						</dt>
						<dd id="default_dd">
	...
	if ($context['fid'])
		echo '
					<input type="submit" name="delete" value="', $txt['delete'], '" onclick="return confirm(', JavaScriptEscape($txt['pages_delete_sure']), ');" class="delete">';
